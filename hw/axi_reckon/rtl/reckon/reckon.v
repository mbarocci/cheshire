...
module reckon #(
    ...
    output wire         SPI_TIMING_MODE,
    output wire [ 31:0] SPI_CYCLES_PER_TICK,
    output wire [ 11:0] SPI_N_EPOCHS,
    output wire [ 11:0] SPI_N_SAMPLES,
    output wire [ 11:0] SPI_BATCH_SIZE,
    output wire [ 11:0] SPI_LABEL_DELAY,
    output wire [ 11:0] SPI_INFER_ACC_DELAY,
    output wire         OUT_REQ,
    input  wire         OUT_ACK,
    ...
    srnn #(
        .N(N),
        .M(M),
    .WINP_MEM_PATH(WINP_MEM_PATH),
    .WOUT_MEM_PATH(WOUT_MEM_PATH),
    .WREC_MEM_PATH(WREC_MEM_PATH),
    .NEUR_MEM_PATH(NEUR_MEM_PATH)
    ) srnn_0 (
        // Global inputs   ------------------------------------
        .CLK(CLK_EXT),
        .RST(RST_sync),
