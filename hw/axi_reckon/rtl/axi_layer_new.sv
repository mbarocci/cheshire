...
(
  ...
  (* dont_touch = "yes" *) (* mark_debug = "true" *) axirf_lite_req_t axi_slv_rf_i;
  (* dont_touch = "yes" *) (* mark_debug = "true" *) axirf_lite_resp_t axi_slv_rf_o;
...
//   assign req.aw_valid  = s_axi_lite_``pat``_awvalid_i  ;            \
  ...
  assign axilite32_waddr = {2'b0, tmp_axilite32_waddr[31:2]};
  assign axilite32_raddr = {2'b0, tmp_axilite32_raddr[31:2]};
  ...
  AXI4_RF_slave_lite_v1_0_S00_AXI # (
    ...
    // .S_AXI_AWPROT (s_axi_lite_rf_awprot_i),
    // .S_AXI_AWVALID(s_axi_lite_rf_awvalid_i),
    // .S_AXI_AWREADY(s_axi_lite_rf_awready_o),

    // .S_AXI_WDATA  (axilite32_wdata),
    // .S_AXI_WSTRB  (s_axi_lite_rf_wstrb_i),
    // .S_AXI_WVALID (s_axi_lite_rf_wvalid_i),
    // .S_AXI_WREADY (s_axi_lite_rf_wready_o),

    // .S_AXI_BRESP  (s_axi_lite_rf_bresp_o),
    // .S_AXI_BVALID (s_axi_lite_rf_bvalid_o),
    // .S_AXI_BREADY (s_axi_lite_rf_bready_i),

    // .S_AXI_ARADDR (axilite32_raddr),
    // .S_AXI_ARPROT (s_axi_lite_rf_arprot_i),
    // .S_AXI_ARVALID(s_axi_lite_rf_arvalid_i),
    // .S_AXI_ARREADY(s_axi_lite_rf_arready_o),

    // .S_AXI_RDATA  (axilite32_rdata),
    // .S_AXI_RRESP  (s_axi_lite_rf_rresp_o),
    // .S_AXI_RVALID (s_axi_lite_rf_rvalid_o),
    // .S_AXI_RREADY (s_axi_lite_rf_rready_i),
